...
基于 LLM 失效模式调研构建，20 项失效模式与对策均有论文/官方基准支撑。

引用经两轮核实：2026-08 首轮（4 处超训练截止引用），**2026-09-01 全面复核**（Claude 三组联网核查 + codex 独立复核），修正了 Kadavath 的反向引用、包幻觉分母口径、SycEval 统计口径，并删除了一处查无原始出处的数字。详见 `references/failure-modes.md` 文末核实记录。
